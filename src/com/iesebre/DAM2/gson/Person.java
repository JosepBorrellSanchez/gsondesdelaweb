...
public class Person {
	...
	String person_homePostalAdress;
	int person_photo;
...
public Person(int i, String string, String string2, String string3,
		String string4, String string5, String string6, int j, String string7,
		String string8, String string9, String string10, int k, int l,
		String string11, String string12, int m, String string13,
		String string14, String string15, int n, int o, String string16,
		String string17, String string18) {
...
public String getPerson_homePostalAdress() {
	return person_homePostalAdress;
}
public void setPerson_homePostalAdress(String person_homePostalAdress) {
	this.person_homePostalAdress = person_homePostalAdress;
}
